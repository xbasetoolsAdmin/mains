<html lang="en">
	...
	<body>
				...
				<div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
					...
					<a class="dropdown-item" href="cPanel" style="color: var(--font-color);">
						<span class="px-2">
							...
							cPanels
							<span class="badge badge-primary">18443</span>
						</span>
					</a>
					<a class="dropdown-item" href="shell" style="color: var(--font-color);">
						<span class="px-2">
							...
							Shells
							<span class="badge badge-primary">2480</span>
						</span>
					</a>
					<a class="dropdown-item" href="ssh" style="color: var(--font-color);">
						<span class="px-2">
							...
							SSH/WHM
							<span class="badge badge-primary">128</span>
						</span>
					</a>
				</div>
			</li>
				...
				<div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
					<a class="dropdown-item" href="premium_shell" style="color: var(--font-color);">
						<span class="px-2">
							...
							Premium Shells
							<span class="badge badge-primary">1170</span>
						</span>
					</a>
					<a class="dropdown-item" href="premium_cPanel" style="color: var(--font-color);">
						<span class="px-2">
							<i class="fas fa-leaf fa-fw"></i>
							Premium cPanels
							<span class="badge badge-primary">7294</span>
						</span>
					</a>
				...
				<div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
					<a class="dropdown-item" href="mailer" style="color: var(--font-color);">
						<span class="px-2">
							<i class="fas fa-leaf fa-fw"></i>
							Mailers
							<span class="badge badge-primary">359</span>
						</span>
					</a>
					<a class="dropdown-item" href="smtp" style="color: var(--font-color);">
						<span class="px-2">
							...
							SMTPs
							<span class="badge badge-primary">2602</span>
						</span>
					</a>
				</div>
			</li>
				...
				<div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
					...
					<a class="dropdown-item" href="leads-6" style="color: var(--font-color);">
						<span class="px-2">
							...
							Phone Number Only
							<span class="badge badge-primary">1085</span>
						</span>
					</a>
		...
		<!-- Page Content -->
		<b>
			<span id="menu-toggle" onmouseover="this.style.cursor='pointer'">
				...
				<div id="divPage">
					<div class="row">
						...
						<div class="content" style="display:inline block;">
							...
							<span>
								<a href="#all" data-toggle="" aria-expanded="true" onclick="TabDiv('all','banksTab1.php')">All</a>
							</span>
							<div class="tab-pane fade" id="static">
								<div class="well well-sm">
									...
									<ul class="user-info">
										<li>
											<b>Do not insert a bank account without SCREENSHOT of it (USE : prntscr.com)</b>
										</li>
										<li>
											<b>ONLY INSERT WORKING ACCOUNT</b>
										</li>
										<li>If you have mistaken or need to edit a tool just remove it and add it again</li>
										<li>
											<b>Deleted</b>
											mean that the tools is not working !</li>
									</ul>
									<ul class="user-info">
										<li>Number of Bank Accounts :
											<b>0</b>
										</li>
										<li>Unsold Bank Accounts :
											<b>0</b>
										</li>
										<li>Sold Bank Accounts :
											<b>0</b>
										</li>
										<li>Deleted Bank Accounts :
											<b>0</b>
										</li>
									</ul>
								</div>
		...
		<div class="tab-pane fade active in" id="all" style="display: block;">
			...
			<div id="shop7" type="delete">
				<a onclick="javascript:delet(7);" class="btn btn-danger btn-xs">remove</a>
			</div>
		</div>
