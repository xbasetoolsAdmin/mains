...
\<link rel="shortcut icon" type="image/x-icon" href="../img/favicon.ico">
  ...
  <link rel="stylesheet" type="text/css" href="css/tickets.css">
	<script type="text/javascript" src="./assets/jquery.js"></script><style type="text/css" id="operaUserStyle">
    video {
    ...
    <div id="sidebar-wrapper">
                ...
                <li><font color="white"><b>Seller Dashboard</b></font></li>
                    <li><a href="./index.html" style="cursor: pointer;">Main</a></li>
		                      <li><a href="./sales.html" style="cursor: pointer;">Sales <div id="sales" class="label label-info">$0</div></a></li>
                ...
                <li><font color="white"><b>Tools Management</b></font></li>
                    <li><a href="./rdp.html" style="cursor: pointer;">RDP <span id="rdp" class="label label-info">0</span></a></li>
                    <li><a href="./shell.html" style="cursor: pointer;">Shell <span id="shell" class="label label-info">0</span></a></li>
                    <li><a href="./cpanel.html" style="cursor: pointer;">cPanel <span id="cpanel" class="label label-info">0</span></a></li>
				<li><a href="./mailer.html">PHP Mailer <span id="mailer" class="label label-info">0</span></a></li>
	<li><a href="./smtp.html">SMTP <span id="smtp" class="label label-info">0</span></a></li>
                    <li><a href="./leads.html">Leads <span id="leads" class="label label-info">0</span></a></li>
                    <li><a href="./scampage.html">Scampage <span id="scams" class="label label-info">0</span></a></li>
                    <li><a href="./tutorial.html">Tutorial/Method <span id="tutorials" class="label label-info">0</span></a></li>
           <li><a href="./banks.html">Bank Accounts <span id="banks" class="label label-info">1</span></a></li>
	      <li><a href="./premium.html">Premium/Shop/Dating <span id="premium" class="label label-info">0</span></a></li>		
            </ul>
...
<table width="100%" id="dataTable" class="table table-striped table-bordered table-condensed sticky-header dataTable no-footer" role="grid" aria-describedby="dataTable_info" style="width: 100%;">        <thead>
 ...
 <tr class="banks-tabel">
	...
	<td> 1254 </td>
    <td> saawd </td>
	<td>  	<a data-toggle="modal" class="btn btn-primary btn-xs" data-target="#myModald7">
<font color="white">Open #7 </font></a><font color="white"> 
...
<button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
    ...
    <td> 2223</td>
    <td> <div id="shop7" type="delete"><a onclick="javascript:delet(7);" class="btn btn-danger btn-xs">remove</a></div></td>
    </tr>
 </tbody>
 </table></div>
