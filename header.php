...
<script src="buyer/layout/js/main.js"></script> <style> body {adding-top: 80px }</style> <script src="buyer/dt/js/jquery.dataTables.min.js"></script> <link rel="stylesheet" href="buyerlayout/css/all.min.css" />
...
<meta name="viewport" content="width=device-width, initial-scale=1.0"><?php ob_start(); session_start(); date_default_timezone_set('UTC'); include "includes/config.php"; if (!isset($_SESSION['sname']) and !isset($_SESSION['spass'])) { header("location: login"); exit(); } $usrid = mysqli_real_escape_string($dbcon, $_SESSION['sname']); ?>  </head>  
<body class="them" 
