<?php ob_start(); session_start(); date_default_timezone_set( 'UTC'); include "includes/config.php"; if (!isset($_SESSION[ 'sname']) and !isset($_SESSION[ 'spass'])) { header( "location: login"); exit(); } $usrid=m ysqli_real_escape_string($dbcon, $_SESSION[
'sname']); ?>
...
<head>
    ...
    <body class="them" style="them">
        ...
        <script src="buyer/js/jquery.dataTables.min.js"></script>
        ...
        <script type="text/javascript">
            function ajaxinfo() {
                $.ajax({
                    ...
                    success: function(o) {
                        if ("01" != o) {
                            o = JSON.parse(o);
                            for (var t in o) $("#" + t).html(o[t]).show()
            ...
            setInterval((function() {
                ajaxinfo()
            }), 3e3), ajaxinfo(), $(document).keydown((function(o) {
                "17" == o.which && !0
            ...
            $(window).on("popstate", (function(o) {
                ...
                })), new Clipboard(".copyit").on("success", (function(o) {
                    ! function setTooltip(o, t) {
                            console.log("hide-1"), $(o).tooltip("hide").attr("data-original-title", t).tooltip("show"), console.log("show")
                        }(o.trigger, "Copied!"),
                        function hideTooltip(o) {
                            setTimeout((function() {
                                $(o).tooltip("hide"), console.log("hide-2")
                            }), 1e3)
                ...
                <div class="collapse navbar-collapse order-1" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown mr-auto">
                            ...
                            <div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="premium" style="color: var(--font-color);"><span class="px-2"><i class="fab fa-linux"></i> SSH/WHM <span class="badge badge-primary"><span id="premium"></span></span></a>
                                <a class="dropdown-item" href="banks" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-leaf fa-fw"></i> Premium Shells <span class="badge badge-primary"><span id="banks"></span></span></a>
                                <a class="dropdown-item" href="scampage" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-leaf fa-fw"></i> Premium cPanels <span class="badge badge-primary"><span id="scampage"></span></span></a>
                        ...
                        <li class="nav-item dropdown mr-auto">
                            ...
                            <div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="leads" style="color: var(--font-color);"><span class="px-2"><i class="fab fa-facebook"></i> Social Media Data <span class="badge badge-primary"><span id="leads"></span></span></a>
                            </div>
                        </li>
                    ...
                    <ul class="navbar-nav profile">
                        ...
                        <li class="nav-item">
                          ...
                          <span id=""> <span class="px-2"><i class="fa fa-plus"></i></span></span> </a>
                        </li>
                        <li class="nav-item dropdown">
